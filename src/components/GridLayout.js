    ...
    <React.Fragment>
      ...
      <div className="wrapper">
        <article>
          ...
          <Row title="comedie" fetchUrl={Requests?.fetchComedyMovies} isPoster= {true}/>
        ...
        <footer>
          ...
          similique laboriosam quas. Itaque dolorum nobis tenetur dolorem
          quidem, dolore distinctio harum, quia maiores ut quae molestias cum
          ducimus facere aliquid tempora inventore quisquam commodi nulla?
          Nostrum suscipit porro quo error eos aliquam molestias perferendis
          repellendus illo neque ut ad, tenetur rerum voluptatem optio possimus
          laboriosam ducimus quasi voluptatibus minima reiciendis omnis! Ipsum
          eos quam tempora repellat, maiores sequi id! A nulla ipsam quaerat
          deserunt autem veniam tempora, voluptatem voluptatum ipsa? Magnam
          cupiditate corrupti, ea est voluptatibus rem dolore quibusdam, odio
          non perferendis iure quia pariatur saepe adipisci harum tempora.
        </footer>
      </div>
    </React.Fragment>
  )
